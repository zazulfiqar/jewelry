...
@section('content')
  ...
  <main class="productPg">
    ...
    <div class="featureSec">
      <div class="container">
        <h2>Feature Diamonds</h2>
        <div class="row">

        @foreach ($diamonds['Diamonds'] as $item)

        @if(isset($item['Images'][0]))
 
             {{-- echo "<pre>";
             print_r($item['Images'][0]['ThumbnailUrl']);
            echo "</pre>"; --}}
         ...
         <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="pro">
              <a href="javascript:void()">
                <div class="proImg">
                  <img src="{{$item['Images'][0]['FullUrl']}}" class="img-responsive" alt="proImg">
                </div>
                <h6>Shape : {{$item['Shape']}}</h6>
                <p>StoneType : {{$item['StoneType']}}</p>
                <p>Price : {{$item['Price']['Value']}} {{$item['Price']['CurrencyCode']}}</p>
              </a>
            </div>
          </div>
