  ...
  <main class="productPg">
    ...
    <div class="featureSec">
      <div class="container">
        ...
        {{-- @php
               echo "<pre>";
            print_r($item['BaseProduct']['Images']);
            echo "</pre>";
        @endphp --}}

@if(isset($item['BaseProduct']['Images']))

            <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="pro">
              <a href="{{ asset('productdetail/'.$item['BaseProduct']['Id']) }}">
                <div class="proImg">
                  <img src="{{$item['BaseProduct']['Images'][0]['FullUrl']}}" class="img-responsive" alt="proImg">
                </div>

                <h6>{{$item['BaseProduct']['Description']}}</h6>



                <p>Starting at {{$item['BaseProduct']['Price']['Value']}} {{$item['BaseProduct']['Price']['CurrencyCode']}}</p>
...
@endif
        ...
        <div class="next">
          <a href="{{route('products')}}"  class="btn btn-success">Back</a>
    ...
    <form action="{{route('nextpage_virtual')}}" method="post" id="myform">
